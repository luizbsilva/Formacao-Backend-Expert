package br.com.kayros.controller.impl;
...
class UserControllerImplTest {
  ...
  void testSaveUserWithNameEmptyThenThrowBadRequest() throws Exception {
    ...
    mockMvc.perform(
        ...
        .andExpect(jsonPath("$.timestamp").isNotEmpty())
        .andExpect(jsonPath(
            "$.errors[?(@.fieldName=='name' && @.message=='Name must contain between 3 and 50 characters')]").exists())
        .andExpect(jsonPath(
            "$.errors[?(@.fieldName=='name' && @.message=='Name cannot be empty')]").exists());
  }
  ...
  void testSaveUserWithInvalidEmailThenThrowBadRequest() throws Exception {
    ...
    mockMvc.perform(
        ...
        .andExpect(jsonPath("$.timestamp").isNotEmpty())
        .andExpect(
            jsonPath("$.errors[?(@.fieldName=='email' && @.message=='Invalid email')]").exists());
  }
  ...
  void testSaveUserWithNullEmailThenThrowBadRequest() throws Exception {
    ...
    mockMvc.perform(
        ...
        .andExpect(jsonPath("$.timestamp").isNotEmpty())
        .andExpect(jsonPath(
            "$.errors[?(@.fieldName=='email' && @.message=='Email cannot be empty')]").exists());
  }
  ...
  void testSaveUserWithEmailContainingLessThenSixCharactersThenThrowBadRequest() throws Exception {
    ...
    mockMvc.perform(
        ...
        .andExpect(jsonPath("$.timestamp").isNotEmpty())
        .andExpect(jsonPath(
            "$.errors[?(@.fieldName=='email' && @.message=='Email must contain between 6 and 50 characters')]").exists());
  }
  ...
  void testSaveUserWithNullPasswordThenThrowBadRequest() throws Exception {
    ...
    mockMvc.perform(
        ...
        .andExpect(jsonPath("$.timestamp").isNotEmpty())
        .andExpect(jsonPath(
            "$.errors[?(@.fieldName=='password' && @.message=='Password cannot be empty')]").exists());
  }
  ...
  void testSaveUserWithPasswordContainingOnlySpacesThenThrowBadRequest() throws Exception {
    ...
    mockMvc.perform(
        ...
        .andExpect(jsonPath("$.timestamp").isNotEmpty())
        .andExpect(jsonPath(
            "$.errors[?(@.fieldName=='password' && @.message=='Password must contain between 6 and 50 characters')]").exists())
        .andExpect(jsonPath(
            "$.errors[?(@.fieldName=='password' && @.message=='Password cannot be empty')]").exists());
  }
  ...
  void testSaveUserWithPasswordContainingLessThenSixCharactersThenThrowBadRequest()
      throws Exception {
    final var request = generateMock(CreateUserRequest.class).withEmail(VALID_EMAIL)
        .withPassword("   ");
  ...
  void testUpdateUserWithPasswordLessThenSixCharactersThenThrowBadRequest() throws Exception {
    final var request = generateMock(UpdateUserRequest.class).withPassword("12345")
        .withEmail(VALID_EMAIL);
